...
from core.vision import analyze_emotion, crop_face, detect_faces, read_image_path
...
def main() -> None:
    ...
    result = {'sample_size': min(60, len(files)), 'distribution': dict(counter), 'examples': examples}
